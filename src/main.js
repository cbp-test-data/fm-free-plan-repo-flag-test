...
const PREPROD_HOST = 'api.saas-qa.beescloud.com'
const PREPROD_CONFIGURATION = {
  API_HOST: PREPROD_HOST,
  CD_API_ENDPOINT: `https://${PREPROD_HOST}/device/get_configuration`,
  CD_S3_ENDPOINT: 'https://rox-conf.saas-qa.beescloud.com/',
  SS_API_ENDPOINT: `https://${PREPROD_HOST}/device/update_state_store/`,
  SS_S3_ENDPOINT: 'https://rox-state.saas-qa.beescloud.com/',
  CLIENT_DATA_CACHE_KEY: 'client_data',
  NOTIFICATIONS_ENDPOINT: 'https://sdk-notification-service.saas-qa.beescloud.com/sse',
  ANALYTICS_ENDPOINT: 'https://fm-analytics.saas-qa.beescloud.com',
